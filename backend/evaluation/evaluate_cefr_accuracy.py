...
TEST_PROMPTS: dict[str, list[str]] = {
    "A1": [
        ...
        "Wie alt bist du?",
        "Wo wohnst du?",
        "Wohnst du in Berlin oder in München?",
        "Magst du lieber Brot oder Wasser?",
        ...
        "Hast du eine Katze?",
        "Wie ist dein Name?",
        "Kommst du aus Spanien oder aus Italien?",
    ],
    "A2": [
        "Ist der Bahnhof weit von hier?",
        "Was kostet das?",
        "Wie viele Kilo Äpfel möchtest du kaufen?",
        "Fährt der Bus um neun Uhr ab?",
        "Regnet es heute?",
        "Warst du gestern zu Hause oder unterwegs?",
        ...
        "Isst du morgens Brot oder Müsli?",
        "Arbeitet dein Vater in einem Büro?",
        "Hast du oft Kopfschmerzen?",
        "Wie war dein Wochenende?",
        "Für wie viele Personen möchtest du einen Tisch reservieren?",
        "Kaufst du Brot beim Bäcker?",
    ...
    "B1": [
        ...
        "Was war ein besonderes Erlebnis in deinem Leben?",
